  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[color:var(--paper)] px-4">
      <div className="max-w-md text-center">
        ...
        <h1 className="mt-4 font-display text-[2rem] font-black leading-[1.05] tracking-tight text-[color:var(--ink)]">
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[color:var(--paper)] px-4">
      <div className="max-w-md text-center">
        ...
        <h1 className="mt-4 font-display text-[1.5rem] font-black leading-[1.05] tracking-tight text-[color:var(--ink)]">
